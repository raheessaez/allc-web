                ...
                <div id="WindowItem-contenedor">
                        ...
                        <div id="BuscarItem">
										<?php
                                            ...
                                            if (!empty($BITEM)) {
                                                  //$FLT_CD_ITM=" WHERE ID_ITM IN(SELECT ID_ITM FROM AS_ITM WHERE CD_ITM Like '%".$BITEM."%') "; 
                                        ...
                                        <table id="Filtro" style="width:100%">
                                                  <tr>
                                                    <td>
                                                        <form action="reg_cotiza.php?NEO=1&V=1" method="post" name="frmbuscar" id="frmbuscar">
                                                      ...
                                                      <?php if(!empty($BITEM)) {?>
                                                        ...
                                                        //oci_execute($RS);
                                                          ...
                                                          $SQL= "SELECT * FROM (SELECT *,ROW_NUMBER() OVER (PARTITION BY ".$CTP." ORDER BY CD_ITM ASC) ROWNUMBER FROM AS_ITM ".$FLT_CD_ITM.$FILTRO_TIENDA.") AS TABLEWITHROWNUMBER WHERE ROWNUMBER BETWEEN ".$LINF." AND ".$LSUP." ";

                                                          $RS = sqlsrv_query($arts_conn, $SQL);
                                                       ?>
                                                        <table id="Listado" style="width:100%">
                                                        <tr>
                                                            <th>C&oacute;d. EAN</td>
                                                            <th>C&oacute;d. ACE</td>
                                                            <th>Nombre</td>
                                                            <th>Precio (<?php echo $MONEDA;?>)</td>
                                                        </tr>
                                                        <?php
														$CUENTATD=1;
                                                       ...
                                                       ?>
                                                        <tr>
                                                            <td><a href="reg_cotiza.php?NEO=1&ID_ITM=<?php echo $ID_ITM?>&ID_BSN_UN=<?php echo $COD_TIENDA_SEL?>&SLS_PRC=<?php echo $SLS_PRC?>&CD_STR_RT_F=<?php echo $CD_STR_RT_F?>&ID_ITM_PS=<?php echo $ID_ITM_PS?>&CD_ITM_SEL=<?php echo $CD_ITM?>&COD_NEGOCIO_SI=<?php echo $COD_NEGOCIO_SEL?>&COD_TIENDA_SI=<?php echo $COD_TIENDA_SEL?>" style="font-size:12pt; font-weight:400"><?php echo $ID_ITM_PS?></a></td>
                                                            <td style="text-align:right"><a href="reg_cotiza.php?NEO=1&ID_ITM=<?php echo $ID_ITM?>&ID_BSN_UN=<?php echo $COD_TIENDA_SEL?>&SLS_PRC=<?php echo $SLS_PRC?>&CD_STR_RT_F=<?php echo $CD_STR_RT_F?>&ID_ITM_PS=<?php echo $ID_ITM_PS?>&CD_ITM_SEL=<?php echo $CD_ITM?>&COD_NEGOCIO_SI=<?php echo $COD_NEGOCIO_SEL?>&COD_TIENDA_SI=<?php echo $COD_TIENDA_SEL?>" style="font-size:12pt; font-weight:400"><?php echo $CD_ITM?></a></td>
                                                            <td><a href="reg_cotiza.php?NEO=1&ID_ITM=<?php echo $ID_ITM?>&ID_BSN_UN=<?php echo $COD_TIENDA_SEL?>&SLS_PRC=<?php echo $SLS_PRC?>&CD_STR_RT_F=<?php echo $CD_STR_RT_F?>&ID_ITM_PS=<?php echo $ID_ITM_PS?>&CD_ITM_SEL=<?php echo $CD_ITM?>&COD_NEGOCIO_SI=<?php echo $COD_NEGOCIO_SEL?>&COD_TIENDA_SI=<?php echo $COD_TIENDA_SEL?>" style="font-size:12pt; font-weight:400"><?php echo $NM_ITM?></a></td>
                                                        ...
                                                        <tr>
                                                           ...
                                                           ?>
                                                            <input name="ANTERIOR" type="button" value="Anterior"  onClick="pagina('reg_cotiza.php?NEO=1&V=1&LSUP_V=<?php echo $FILA_ANT?>&LINF_V=<?php echo $ATRAS?>&BITEM=<?php echo $BITEM?>&FTIENDA=<?php echo $COD_TIENDA_SEL?>&COD_NEGOCIO_SI=<?php echo $COD_NEGOCIO_SEL?>&COD_TIENDA_SI=<?php echo $COD_TIENDA_SEL?>');">
                                                            <?php
                                                            }
                                                            if ($LSUP_V<=$TOTALREG) {
                                                                $ADELANTE=$LSUP_V+1;
                                                           ...
                                                           ?>
                                                            <input name="SIGUIENTE" type="button" value="Siguiente" onClick="pagina('reg_cotiza.php?NEO=1&V=1&LSUP_V=<?php echo $FILA_POS?>&LINF_V=<?php echo $ADELANTE?>&BITEM=<?php echo $BITEM?>&FTIENDA=<?php echo $COD_TIENDA_SEL?>&COD_NEGOCIO_SI=<?php echo $COD_NEGOCIO_SEL?>&COD_TIENDA_SI=<?php echo $COD_TIENDA_SEL?>');">
                                                            <?php }?>
