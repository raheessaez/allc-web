...
<table  id="encabezado"width="100%">
  ...
  <tr>
    ...
    <td align="left" width="156px"></td>

    <td align="left" nowrap="nowrap"><p style="text-align:left; margin:0; padding:0">Alliances Retail </p>

      <p style="text-align:left; margin:0; padding:0">Management Suite</p></td>

    <td align="center"><?php include ("../menu_estado.php"); ?></td>

    <td align="right"><ul id="MenuUser">

        <li><a href="#">en sesi&oacute;n: <?php echo $GLBENSESION ?></a>

          <ul>

            <li>

              <p style="margin-top:10px; margin-right:10px;"><span style="font-weight:600"><?php echo $GLBENSESION ?></span> en sesi&oacute;n con perfil <span style="font-weight:600"><?php echo $GLBELPERFIL ?></span> para <span style="font-weight:600"><?php echo $GLBELCLIENTE ?></span></p>
            ...
            <li>
              ...
              <a href="#" class="enlaceClave" onclick="ActivarVentana();">Cambiar clave</a> <a href="../hastaluego.php" class="enlaceSesion">Cerrar sesi&oacute;n</a> </li>
...
<div id="Ventana" style="display:none">
  ...
  <div id="Ventana-contenedor" style="width:420; height:280; margin-left: -210px; top:75px"> <span style="position:absolute; top:0; right:20px;"> <img src="../images/ICO_Close.png" border="0" onClick="CerrarVentana();" title="Cerrar ventana"> </span>
    ...
    <table id="forma-registro">
      ...
      <form action="<?php echo $LAURLACTUAL ?>" method="post" name="formact" onSubmit="return validaClave(this)">
        ...
        <tr>
          ...
          <td><label for="CLAVE_OLD">Contrase&ntilde;a original</label></td>

          <td><input name="CLAVE_OLD" type="password" size="30" maxlength="20"></td>

        </tr>

        <tr>

          <td><label for="CLAVE_NEO">Nueva Contrase&ntilde;a</label></td>

          <td><input name="CLAVE_NEO" type="password" size="30" maxlength="20"></td>

        </tr>

        <tr>

          <td><label for="CLAVE_VAL">Repetir Nueva Contrase&ntilde;a</label></td>

          <td><input name="CLAVE_VAL" type="password" size="30" maxlength="20"></td>
        ...
        <tr>
          ...
          <td><input name="CAMBIARCLAVE" type="submit" value="Cambiar mi Clave de Usuario"></td>
